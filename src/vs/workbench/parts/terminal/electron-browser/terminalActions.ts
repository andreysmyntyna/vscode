...
export class QuickOpenActionTermContributor extends ActionBarContributor {
	...
	public getActions(context: any): IAction[] {
		...
		if (context.element instanceof TerminalEntry) {
			actions.push(new RenameTerminalActionQP(RenameTerminalAction.ID, RenameTerminalAction.LABEL, this.quickOpenService, this.terminalService, this.instantiationService, context.element));
		}
		return actions;
	}
...
export class RenameTerminalActionQP extends Action {

	public static ID = 'workbench.action.terminal.renameQP';
	public static LABEL = nls.localize('workbench.action.terminal.renameQP', "RenameQP");
